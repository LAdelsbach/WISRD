...
# Initial conditions
theta = math.radians(45)  # Initial angle (converted to radians)
xfirst = 5.25  # Reasonable starting x speed (m/s)
zfirst = 5.25  # Initial positive z speed (m/s) - assuming it is launched with an upward component
thetafirst = 0  # Initial angular velocity (rad/s)
...
with open('/Users/lukeadelsbach/Desktop/WISRD/DiffiqApprox/FinalAnalysis/SimulationsData/dataTest.txt', 'w') as file:

...
#This is the loop for different launch angles
for i in range(100):
    # Constants
    g = 9.80665  # Acceleration due to gravity (m/s^2)
    ...
    # Initial conditions
    theta = math.radians(45)  # Initial angle (converted to radians)
    xfirst = 11.05 - i/10  # Reasonable starting x speed (m/s)
    zfirst = 11.05 - i/10  # Initial positive z speed (m/s) - assuming it is launched with an upward component
    thetafirst = 0  # Initial angular velocity (rad/s)
    ...
    with open('/Users/lukeadelsbach/Desktop/WISRD/DiffiqApprox/FinalAnalysis/TestingData/data' + str(i) + '.txt', 'w') as file:
